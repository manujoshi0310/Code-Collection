...
lenaResizeNearest=lenaResizeNearest.save("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeNearest.bmp")
...
lenaResizeBilinear=lenaResizeBilinear.save("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeBilinear.bmp")
...
lenaResizeBicubic=lenaResizeBicubic.save("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeBicubic.bmp")
...
lena1 = img.imread("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lena512.bmp")

lenaNearestPrint = img.imread("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeNearest.bmp")
lenaBilinearPrint = img.imread("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeBilinear.bmp")
lenaBicubicPrint = img.imread("C:/Users/Manu/Downloads/ImageProcessing/PA1_Images/lenaResizeBicubic.bmp")
plt.figure()
plt.imshow(lena1)
plt.figure()
plt.imshow(lenaNearestPrint)
print(PSNR(lena1, lenaNearestPrint))
plt.figure()
plt.imshow(lenaBicubicPrint)
print(PSNR(lena1, lenaBicubicPrint))
plt.figure()
plt.imshow(lenaBilinearPrint)
print(PSNR(lena1,lenaBilinearPrint))